...
#[Fillable(['item_type', 'catalog_product_id', 'catalog_bundle_id', 'catalog_product_sale_package_id', 'product_name', 'contents_snapshot', 'sale_package_name', 'sale_package_quantity', 'unit_price', 'quantity', 'line_total'])]
class OrderItem extends Model
{
    protected function casts(): array { return ['sale_package_quantity' => 'integer', 'unit_price' => 'decimal:2', 'line_total' => 'decimal:2']; }
