...
#[Fillable(['folio', 'customer_id', 'created_by', 'ordered_at', 'delivery_at', 'delivery_time', 'delivery_place', 'status', 'discount_type', 'discount_value', 'subtotal', 'discount_amount', 'has_shipping', 'shipping_cost', 'total', 'advance_payment', 'balance_due', 'observations', 'archived_at'])]
