    ...
    <div class="offcanvas-body">
        <nav class="admin-sidebar-nav" aria-label="Menu administrativo">
            ...
            @can('orders.view')
                ...
                <a class="{{ request()->routeIs('admin.drive-gallery.*') ? 'active' : '' }}" href="{{ route('admin.drive-gallery.index') }}"><i class="bi bi-images"></i><span><strong>Galería Drive</strong><small>Imágenes y descargas</small></span></a>
                ...
                <a class="{{ request()->routeIs('admin.reports.sales') ? 'active' : '' }}" href="{{ route('admin.reports.sales') }}"><i class="bi bi-graph-up-arrow"></i><span><strong>Reportes</strong><small>Ventas, gastos y utilidad</small></span></a>
                <a class="{{ request()->routeIs('admin.reports.commissions*') ? 'active' : '' }}" href="{{ route('admin.reports.commissions') }}"><i class="bi bi-cash-coin"></i><span><strong>Comisiones</strong><small>Pago por ventas propias</small></span></a>
                <a class="{{ request()->routeIs('admin.expenses.*') ? 'active' : '' }}" href="{{ route('admin.expenses.index') }}"><i class="bi bi-wallet2"></i><span><strong>Gastos</strong><small>Publicidad e insumos</small></span></a>
