...
<section class="admin-section"><div class="container">
    ...
    <div class="admin-header"><div><div class="eyebrow">Comunicación</div><h1 class="fw-bold mt-2 mb-0">Campañas de mailing</h1></div>@can('mailing.manage')<a class="btn btn-dark" href="{{ route('admin.mailing.create') }}"><i class="bi bi-plus-circle me-2"></i>Nueva campaña</a>@endcan</div>
