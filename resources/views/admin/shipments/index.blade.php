...
<div class="admin-header"><div><div class="eyebrow">Operación</div><h1>Envíos y seguimiento</h1></div>@can('shipments.manage')<a class="btn btn-dark" href="{{ route('admin.shipments.select-order') }}"><i class="bi bi-plus-lg me-2"></i>Nuevo envío</a>@endcan</div>
